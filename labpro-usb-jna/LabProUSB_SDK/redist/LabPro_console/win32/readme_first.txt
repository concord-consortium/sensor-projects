Please run copy_win32_wdapi_dll.exe once from this folder before the first time you run LabPro_console.exe.
...
When you install LabProUSB.dll on your system, you must copy the correct version of wdapi921_WINmmforOSnn.dll into the same folder where LabProUSB.dll resides, and rename wdapi921_WINmmforOSnn.dll to wdapi921.dll.
