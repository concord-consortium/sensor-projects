...
//
typedef int (*VST_USB_Bulk_Data_Callback)(unsigned char* pBytes, unsigned int nNumBytes, void* pContext);

//
// We support different reading modes for bulk transfers
//
typedef enum
{
...
//	Boolean				bUsesDirectRead;
    ...
    Boolean				bPleaseExitListenerThread;
    Boolean				bListenerThreadExited;
...
/* * * * * * * * * * * * * * * * * * *
	...
	// Callback looks like: 
	//			int MyCallback(unsigned char* pBytes, unsigned int nNumBytes, void* pContext)
